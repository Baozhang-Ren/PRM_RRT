...
if __name__ == '__main__':
    ...
    roadmap3 = Roadmap3.RoadMap()
    roadmap3.build_roadmap()
    print('roadmap_size', len(roadmap3.E))

    for i in range(len(start_list)):
        start_time = time.time()
        prm = PRM(roadmap3, start_list[i], goal_list[i])
    ...
    with open('time_list_3.txt', 'w') as f:
    ...
    with open('quality_list_3.txt', 'w') as f:
